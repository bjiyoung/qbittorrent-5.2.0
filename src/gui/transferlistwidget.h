...
private slots:
    ...
    void saveSettings();
    void handleTorrentFinishedForAutoComplete(BitTorrent::Torrent *torrent);
    void handleTorrentsUpdatedForAutoComplete(const QList<BitTorrent::Torrent *> &torrents);
...
private:
    ...
    QSet<BitTorrent::Torrent *> m_pendingAutoComplete;
};
