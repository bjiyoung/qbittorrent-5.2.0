...
private:
    ...
    void applyMinSizeFilter();
    void saveMinSizeFilterSettings();
    void loadMinSizeFilterSettings();
    void startOkCountdown();
    void stopOkCountdown();
    ...
    // Min-size filter widgets
    QCheckBox *m_minSizeCheckBox = nullptr;
    QSpinBox  *m_minSizeSpinBox  = nullptr;
    QComboBox *m_minSizeUnitCombo = nullptr;
